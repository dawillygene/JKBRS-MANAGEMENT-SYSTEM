...
function EmployeeIndexContent({ employees, offices, departments, filters }: EmployeeIndexProps) {
  ...
  const handleDelete = (employee: Employee) => {
    const employeeName = employee.full_name || `${employee.first_name || ''} ${employee.last_name || ''}`.trim() || 'this employee';
                        ...
                        <tr key={employee.id} className="border-b hover:bg-muted/50 transition-colors">
                          <td className="py-4">
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                <div className="font-medium">{employee.full_name || `${employee.first_name || ''} ${employee.last_name || ''}`.trim() || 'Unknown Employee'}</div>
